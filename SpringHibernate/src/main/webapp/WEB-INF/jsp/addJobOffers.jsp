...
<body>
	<div class="container">
		...
		<form:form method="post" modelAttribute="jobOffer" class="form-horizontal">
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<form:select path="company.id" items="${companiesList}" class="form-control input-sm" />
						<div class="has-error">
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<form:input type="text" path="maxSalary" class="form-control input-sm" />
					</div>
				</div>
			</div>
		...
		<form:form method="post" modelAttribute="jobOfferSkills" class="form-horizontal">
			<form:input type="hidden" path="id" id="id" />
